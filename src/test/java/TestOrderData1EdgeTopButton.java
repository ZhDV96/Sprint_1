...
public class TestOrderData1EdgeTopButton {
    ...
    //тест на возможность оформления заказа в сервисе через браузер MS Edge c первым набором данных
    @Test
    public void testOrderData1 () {
        //первая часть теста, где проверяется возможность заполнения полей формы заказа
        orderPage.order("Иван", "Иванов", "ул. Машиностроителей, д.30, стр.1", "+79999999999", "Черкизовская");
