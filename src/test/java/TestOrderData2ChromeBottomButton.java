...
public class TestOrderData2ChromeBottomButton {
    ...
    //тест на возможность оформления заказа в сервисе через браузер Chrome со вторым набором данных
    @Test
    public void testOrderData2 () {
        //первая часть теста, где проверяется возможность заполнения полей формы заказа
        orderPage.orderTwoButtonBottom("Елена", "Рекурсивная", "ул. Интегральная, д.17, стр.1", "+76666666666", "Сокольники");
